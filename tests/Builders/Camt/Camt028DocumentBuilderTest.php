 ...
 * Filename     : Camt028DocumentBuilderTest.php
...
class Camt028DocumentBuilderTest extends BaseTestCase {
    #[Test]
    ...
    public function testDocumentWithAllFields(): void {
        ...
        $document = Camt028DocumentBuilder::create('ASSIGN-002')
            ...
            ->withOriginalAmount(3000.00, CurrencyCode::Euro)
            ->build();
        ...
        $this->assertEquals(3000.00, $document->getOriginalInterbankSettlementAmount());
    }
    ...
    public function testAssignmentIdMaxLength(): void {
        ...
        Camt028DocumentBuilder::create(str_repeat('A', 36));
    }

    #[Test]
    public function testBuilderIsImmutable(): void {
        $builder1 = Camt028DocumentBuilder::create('ASSIGN-004');
