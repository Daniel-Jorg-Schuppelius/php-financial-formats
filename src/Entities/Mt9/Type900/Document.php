...
namespace CommonToolkit\FinancialFormats\Entities\Mt9\Type900;
...
/**
 * MT900 Document - Confirmation of Debit.
 * 
 * Sent by an account servicing institution to an account owner to confirm
 * the debit entry made to the account owner's account.
 * 
 * This message is used to notify the account owner of a debit that has
 ...
 * 
 * @package CommonToolkit\Entities\Common\Banking\Mt9\Type900
 */
